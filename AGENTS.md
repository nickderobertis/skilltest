...
<!-- llmlint: ignore-block[instruction_layer_localized] The provider boundary spans core, CLI, SDKs and CI, so it sits at the root; nesting its provider-internal detail is follow-up "Localize package- and provider-specific instructions out of skilltest's root AGENTS.md". -->
